# 🌍 YatriGo — "Not just miles, but moments."
...
### 9. 🗓️ Plan Your Trip Itinerary Seamlessly

    You can organize your entire travel plan in one place. From choosing the destination to creating a day-wise itinerary — plan like a pro!

   - 📍  Select your destination and travel dates

   - 🏨 Add places to visit, stays, and food spots

   - 🕒 Create a day-by-day schedule

   - 🤝 Share your itinerary with friends or co-travelers

   - ✅ Stay on track while traveling

  ![image](https://github.com/user-attachments/assets/c8b2fd9f-db18-4373-88e8-ae653b62a652)


### 10. ⚙️ Settings – Manage Your Account

   YatriGo gives you full control over your account and preferences. From privacy to profile updates — everything is just a tap away.

   - ✏️ Edit your profile details (name, bio, picture)
   ...
   - 🗑️ Option to delete or deactivate your account
    
   ![image](https://github.com/user-attachments/assets/479548f1-b6d4-402f-b33f-7f0b05f33aab)


### 11. 🔍 Search – Discover Destinations and Profiles

   YatriGo’s powerful search lets you find exactly what you need in seconds.

   - 🔎 Search for destinations by name, region, or tags (e.g., “beach,” “mountain”)

   - 👤 Look up fellow travelers’ profiles or hashtags to explore their content

   - 📅 Filter search results by travel dates, popularity, or recent posts

   - ⭐ Save frequent searches for quick access

   - 🚀 Instant suggestions as you type, for a seamless experience


![image](https://github.com/user-attachments/assets/63eea11f-d4de-467d-8f82-7d2db22253ee)


### 12. 🚪 Logout & 🗑️ Deactivate Account

   YatriGo gives users full control over their presence and privacy.

   - 🚪 Logout securely from any device with a single tap

   - 🗑️ Deactivate Account if you wish to take a break or leave
